...
% Plotting a vector perpendicular to a plane formed by 2 other vectors
% vect1 = [XYZ_Origin;3 5 3];
% plot3(vect1(:,1),vect1(:,2),vect1(:,3),'-.c', 'LineWidth',0.5);
% 
% vectx1 = cross(vect1, vecx);
% plot3(vectx1(:,1),vectx1(:,2),vectx1(:,3),'y', 'LineWidth',0.5);

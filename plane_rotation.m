...
%     R_XY = [cos(theta) 0 sin(theta); sin(theta)^2 cos(theta) -sin(theta)*cos(theta); cos(theta)*sin(theta) sin(theta) cos(theta)^2];
    ...
    vec_np = pt - point1;
    vec_np = [point1; point1+vec_np];
    vec_np_UV = vec_np./vecnorm(vec_np);
    plot3(vec_np(:,1),vec_np(:,2),vec_np(:,3),'m', 'LineWidth',0.5);
...
%     R_XY = [cos(theta) 0 sin(theta); sin(theta)^2 cos(theta) -sin(theta)*cos(theta); cos(theta)*sin(theta) sin(theta) cos(theta)^2];
    ...
    % Cheating code
    plot3(point4(1),point4(2),point43_n(3),'oc');
...
%     R_XY = [cos(theta) 0 sin(theta); sin(theta)^2 cos(theta) -sin(theta)*cos(theta); cos(theta)*sin(theta) sin(theta) cos(theta)^2];
    ...
    plot3(point42_n(1),point42_n(2),point42_n(3),'oy');
     ...
     % Cheating code
    plot3(point4(1),point4(2),point42_n(3),'oc');

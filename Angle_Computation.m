...
plot3(point5A(1),point5A(2),point5A(3),'oc');
plot3(point5B(1),point5B(2),point5B(3),'oc');
plot3(point5C(1),point5C(2),point5C(3),'oc');
plot3(point5D(1),point5D(2),point5D(3),'oc');
